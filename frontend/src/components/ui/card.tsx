...
function CardTitle({ className, ...props }: React.ComponentProps<'h2'>) {
  return (
    // A real heading element, not a styled div — see docs/standards/accessibility.md
    // ("respect heading order and landmark structure").
    // eslint-disable-next-line jsx-a11y/heading-has-content -- children come from each call site
    <h2
